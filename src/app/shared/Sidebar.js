    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          ...
          {
            role == 1 ? <>
              <li className={ this.isPathActive('/admin/prize') ? 'nav-item active' : 'nav-item' }>
                <Link className="nav-link" to="/admin/prize">
                  <span className="menu-title"><Trans>Prize</Trans></span>
                  <i className="mdi mdi-ticket menu-icon"></i>
                </Link>
              </li>
              <li className={ this.isPathActive('/admin/voucher') ? 'nav-item active' : 'nav-item' }>
